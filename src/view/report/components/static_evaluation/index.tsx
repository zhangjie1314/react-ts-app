            ...
            <div className={StaticEvaluationStyle['data-item']} key={index}>
                <div className={StaticEvaluationStyle['item-top-box']}>
                    ...
                    <div className={StaticEvaluationStyle['itb-inline-box']}>
                        {data.photoImg ? (
                            <img className={StaticEvaluationStyle['comp-img']} src={data.photoImg} alt='原图' />
                        ) : null}
                        <img className={StaticEvaluationStyle['comp-img']} src={data.img} alt='标准图' />
                        <div className={StaticEvaluationStyle['itb-data-box']}>
                            <div className={StaticEvaluationStyle['itbd-line']}>
                                <div
                                    className={`${StaticEvaluationStyle['il-item']} ${
                                        level === '正常' ? StaticEvaluationStyle['il-selected-zc'] : ''
                                    }`}
                                >
                                    <div className={StaticEvaluationStyle['ii-line']}>
                                        {level === '正常' ? (
                                            <div className={StaticEvaluationStyle['ii-cur-val']}>{data.angle}</div>
                                        ) : null}
                                    </div>
                                    <div className={StaticEvaluationStyle['ii-txt']}>正常</div>
                                </div>
                                <div
                                    className={`${StaticEvaluationStyle['il-item']} ${
                                        level === '轻微' ? StaticEvaluationStyle['il-selected-qw'] : ''
                                    }`}
                                >
                                    <div className={StaticEvaluationStyle['ii-line']}>
                                        {level === '轻微' ? (
                                ...
                                <div
                                    className={`${StaticEvaluationStyle['il-item']} ${
                                        level === '中度' ? StaticEvaluationStyle['il-selected-zdu'] : ''
                                    }`}
                                >
                                    <div className={StaticEvaluationStyle['ii-line']}>
                                        {level === '中度' ? (
                                ...
                                <div
                                    className={`${StaticEvaluationStyle['il-item']} ${
                                        level === '重度' ? StaticEvaluationStyle['il-selected-zd'] : ''
                                    }`}
                                >
                                    <div className={StaticEvaluationStyle['ii-line']}>
                                        {level === '重度' ? (
